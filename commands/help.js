...
const DEFAULT_PROMPT = 'You are a helpful assistant for the Killua lite WhatsApp Bot. Help users with bot commands and features.';
...
function getLocalResponse(query) {
    ...
    if (q.includes('owner') || q.includes('who made') || q.includes('creator')) {
        return 'Killua Lite is owned by **Killua Mods** (+243906905464). Powered by Killua Team.';
    }
    if (q.includes('channel') || q.includes('newsletter')) {
        return '📢 Join our channel **Killua**: https://whatsapp.com/channel/0029VbCHB1eDjiOUGG4OCS2t';
    }
    if (q.includes('command') || q.includes('feature') || q.includes('what can')) {
        return 'Killua has 60+ commands: Downloader, AI, Search, Tools, Group Management, Owner. Type .menu to see all!';
    }
