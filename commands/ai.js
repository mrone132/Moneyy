...
function getLocalFallback(query) {
    ...
    const responses = {
        'hello': 'Hello! I\'m Killua AI. How can I assist you today? 🤖',
        'hi': 'Hi there! 👋 I\'m Killua AI, ready to help!',
        'who are you': 'I\'m Killua AI, an advanced language model! 🤖',
        'what is your name': 'My name is Killua AI! ⚡',
    };
