        ...
        try {
            ...
            const doc = new PDFDocument({
                ...
                info: {
                    Title: title,
                    Author: 'killuaMods',
                    Creator: 'killua Document Generator',
                },
            });
...
<body>
    ...
    ${htmlParagraphs}
    <p class="footer">Generated by Killua · Powered by 𝐊𝐈𝐋𝐋𝐔𝐀 𝐓𝐄𝐀𝐌</p>
</body>
</html>`;
}
...
function textToMarkdown(text, title = 'Document') {
    ...
    md += `---\n\n`;
    md += `*Generated by killua Bot · Powered by 𝐊𝐈𝐋𝐋𝐔𝐀 𝐓𝐄𝐀𝐌*`;
    return md;
}
...
\\pard\\sa200\\fs24
${rtfParagraphs}
\\pard\\qc\\fs18\\cf2 Generated by killua Bot · Powered by 𝐊𝐈𝐋𝐋𝐔𝐀 𝐓𝐄𝐀𝐌\\cf1
}`;
}
