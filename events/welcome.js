...
const FALLBACK_IMAGES = [
    'https://files.catbox.moe/fbdpeu.jpg',
    'https://files.catbox.moe/qbcgh3.jpg',
...
const DEFAULT_AVATAR = 'https://files.catbox.moe/h7ajed.jpg';
        ...
        if (buffer.length > 500) {
            await sock.sendMessage(groupId, {
                ...
                caption:
                    ...
                    `📢 ${groupName}\n` +
                    `👥 𝗠𝗲𝗺𝗯𝗲𝗿𝘀: ${memberCount}\n\n` +
                    `𝑼𝒔𝒆 *.welcome* off to disable this event\n` +
                    '🧃 _Powered by Killuamods',
