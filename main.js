'use strict';
// ╔══════════════════════════════════════════════════════════════╗
// ║         KILLUA BOT — main.js (CommonJS) v5.2.0             ║
...
const CONFIG = {
  ...
  botName     : process.env.BOT_NAME || 'KILLUA LITE',
  maxSubBots  : parseInt(process.env.MAX_SUBBOTS) || 15,
  cooldownMinutes: 3,
  channelLink : process.env.BOT_CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbCHB1eDjiOUGG4OCS2t',
  groupsToJoin: [
...
// ═══════════════════════════════════════
(async () => {
  console.log('\n  \x1b[45m\x1b[37m  ⚡ KILLUA LITE — DEMAR  \x1b[0m\n');
